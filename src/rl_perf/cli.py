...
def targets(
    ...
    hardware: str = typer.Option(
        ..., "--hardware", "-hw", help="Hardware config YAML or shortname (910C, CM384)"
    ),
    ...
    time_budget: float = typer.Option(
        None, "--time-budget", "-t", help="Time budget in hours"
    ),
    ...
    def _run():
        ...
        rl_cfg = RLConfig(
            ...
            train_micro_batch_size=train_batch,
        ...
        report = perf.derive_targets(
            devices, rl_cfg, gen_parallel, train_parallel, time_budget
        )
